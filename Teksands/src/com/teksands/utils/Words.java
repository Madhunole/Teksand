...
/**
 * http://www.javaservletsjspweb.in/2009/05/java-class-to-convert-number-into-words.html
...
public class Words
{
	 ...
	 private String belowLakh(long x)
	 {
	  ...
	  if(length(x)==4)
	   ...
	   return belowHundred(leftChars(x,2))+"Thousands "+belowThousand(rightChars(x,3));
	 }
	 ...
	 public String belowBilion(long x)
	 {
	  ...
	  if(length(x)==8)
	   ...
	   return belowHundred(leftChars(x,2))+"Crores "+belowCrore(rightChars(x,7));
	 }
