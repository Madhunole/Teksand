...
$(document).ready(function() {
    var table = $('#admin_ebp_candidate').removeAttr('width').DataTable( {
        columnDefs: [
            { width: 100, targets: 1 }
        ],
        responsive: true,
...
function showDetails(id)
{
	...
	$.post("/admin/getEBPCandidateById", {id: "" + id + "", }, function(data)
	{		
		var result = $.trim(data);
  		var obj = jQuery.parseJSON(result);
  		
  		$("#ebp_candidate_view").modal('show');
	  	...
	  	$("#span_year_passing").html(obj.year_passing);
	  	$("#span_qualification").html(obj.qualification);
	  	$("#span_position").html(obj.position);
...
function downloadXl()
{
	top.location =  "/ebpCondidatesdownloadXL";
}
</script>
	...
	<section class="section bgw">
	    <div class="container-fluid">
	        <div class="section-title-2 text-center course-title">
	            <h2>Teksands EBP Candidates</h2>
	            <hr>
	        </div><!-- end section-title -->
	        <a href="#" onClick="downloadXl();" class="btn btn-primary btn-sm mb-20"><i class="fa fa-file-excel-o"></i> Download Excel</a>
			<div class="table-responsive">
            	<table id="admin_ebp_candidate" class="table table-striped table-bordered dt-responsive" style="width:100%;font-size:12px;">
			        ...
			        <tbody>
				        <c:forEach items="${ebpCandidateList}" var="ebpCandidateList">
				            <tr>
				                <td><c:out value="${ebpCandidateList.id}" /></td>
				                <td><c:out value="${ebpCandidateList.name}" /></td>
				                <td><c:out value="${ebpCandidateList.mobile}" /></td>
				                <td><c:out value="${ebpCandidateList.email}" /></td>
				                <td><c:out value="${ebpCandidateList.city}" /></td>
				                <td><fmt:formatDate value="${ebpCandidateList.date}" pattern="dd-MMM-yyyy"/></td>
				                <td><button type="button" class="btn btn-primary btn-xs" onclick="showDetails(${ebpCandidateList.id})">View</button></td>
				            </tr>
				        </c:forEach>
			        </tbody>
				</table>
...
<div id="ebp_candidate_view" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="popup-modal" data-dismiss="modal">&times;</button>
		<h4 class="text-center"><b>Admin - EBP Candidate Details</b></h4>
      </div>
		      ...
		      <div class="col-md-12">
                 <div class="tab-first menu-center">
                     <ul class="nav nav-tabs" role="tablist" style="border: 0px solid #ddd;">
                         ...
                         <li role="presentation"><a href="#descriptions" aria-controls="descriptions" role="tab" data-toggle="tab">Descriptions</a></li>
                                 ...
                                 <table class="table table-bordered">
								  ...
								  <tbody>
								    ...
								    <tr>
									    ...
									    <td><span id="span_position"></span></td>
								    </tr>
								  	<tr>
										<td><b>Year of Passing</b></td>
									    <td><span id="span_year_passing"></span></td>
								    </tr>
								    <tr>
                                 ...
                                 <table class="table table-bordered">
								  ...
								  <tbody>
								    ...
								    <tr>
									    ...
									    <td><span id="span_linkedin_url"></span> - <span id="span_pincode"></span></td>
								    </tr>
								  </tbody>
							</table>
