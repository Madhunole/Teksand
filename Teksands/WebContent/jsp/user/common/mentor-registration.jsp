...
function saveMentors()
{
    ...
    var linkedin_url = $("#bat_linkedin").val();
    ...
    if(tech_description == "") {
    	swal("OOPS!", "Please Enter Your Industry Experience", "error");
	 	return false;
    }
    
    if(linkedin_url == "") {
    	swal("OOPS!", "Please Enter Your LinkedIn Profile", "error");
	 	return false;
    }
	...
	$.post("/saveMentor", {name: "" + name + "", 
		...
		tech_description: "" + tech_description + "",}, function(data)
	{		
    ...
    <div class="container clearfix">
       ...
       <div class="pull-left">
           <div class="bread">
               <ol class="breadcrumb">
                   <li><a href="#">Home</a></li>
                   <li class="active">Mentor Registration</li>
               </ol>
           </div><!-- end bread -->
       </div><!-- /.pull-right -->
    </div>
...
<section class="section bgw course-section">
    <div class="container">
        <div class="section-title-2 text-center course-title">
            <h1 class="home-h1">Mentor Benefits & features</h1>
            <hr>
			    ...
			    <div class="section-title-2 text-center trainer-section">
                    ...
                    <div class="row profile-badges contact-rm">
                        <div class="contact_form">
						  <div class="row">
						    <div class="col-md-12">
						      <input type="text" id="bat_name" class="form-control" placeholder="Name *" onkeydown="return /[a-z ]/i.test(event.key)" maxlength="100" required>
						    </div>
						  </div>
						  <div class="row">
						  ...
						  <div class="row">
						    <div class="col-md-6">
						      <input type="text" class="form-control" id="bat_mobile"  onkeypress='return isNumberKey(event);' placeholder="Mobile *" required>
						    </div>
						    <div class="col-md-6">
						  ...
						  <div class="row">
							  <div class="col-md-12">
                                   <textarea class="form-control" id="bat_con_des" placeholder="Briefly describe if you have any prior mentorship experience" required></textarea>
                                 </div>
                                </div>
                                <div class="row">
							  		<div class="col-md-12">
                                ...
                                <div class="row">
								    <div class="col-md-12">
								      <input type="text" class="form-control" id="bat_linkedin" placeholder="Enter Your LinkedIn Profile URL *">
								    </div>
								  </div>
                                 <div class="row">
	                                 <div class="col-md-12">
	                                   <div class="text-center"><button type="button" value="submit" id="submit" class="btn btn-primary" onclick="saveMentors()"> Register</button></div>
	                                </div>
								</div>
                        </div>
                    </div><!-- end row -->
