...
$(document).ready(function(){
	...
	$("#file").change(function() 
	{
	   ...
	   $("#txt_resume_mobile").val(car_mobile);
...
function saveCareer()
{
    ...
    var gender = $("input:radio[name='car_gender']:checked").val();
    var mobile = $("#car_mobile").val();
    var email = $("#car_email").val();
    var address1 = $("#car_addr1").val();
    var address2 = $("#car_addr2").val();
    var city = $("#car_city").val();
    var state= $("#car_state").val();
    var country = $("#car_country").val();
    var pincode = $("#car_pincode").val();
    var core_skills = $("#car_skill").val();
    var experience = $("#car_exp").val();
    var resume = $("#para_resume").html();
    var role = $("#car_role").val();
    ...
    if(pincode == "") {
    	swal("OOPS!", "Please Select Enter Your Pincode", "error");
	 	return false;
    }
    ...
    if(role == "") {
    	swal("OOPS!", "Please Enter Your Role", "error");
	 	return false;
    }
		...
		var result = $.trim(data);
  		var obj = jQuery.parseJSON(result);
   		if(obj.status_code == 200)
   		{
	   		...
	   		$("#car_name").val("");
	   	    $("input:radio[name='car_gender']:checked").val("");
	   	    $("#car_addr1").val("");
	   	    $("#car_addr2").val("");
	   	    $("#car_city").val("");
	   	    $("#car_state").val("");
        ...
        <div id="sidebar1" class="col-md-12 col-sm-12">
            <div class="clearfix">
			    ...
			    <div class="section-title-2 text-center course-section">
				  ...
				  <div class="row">
				    <div class="col-md-12">
				      <input type="text" id="car_name" class="form-control" placeholder="Name *" maxlength="100" onkeydown="return /[a-z ]/i.test(event.key)" required>
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-12" style="margin: 0 0 20px 0;">
					    ...
					    <label class="radio-inline">
						  <input type="radio" name="car_gender" value="male" checked> Male
						</label>
						<label class="radio-inline">
						  <input type="radio" name="car_gender" value="female"> Female
						</label>
						<label class="radio-inline">
						  <input type="radio" name="car_gender" value="other"> Other
						</label>
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-6">
				      <input type="text" class="form-control" id="car_mobile" placeholder="Mobile *" required onkeypress='return isNumberKey(event);' onchange="mobileChange()">
				    </div>
				    <div class="col-md-6">
				      <input type="text" class="form-control" id="car_email" placeholder="Email *" maxlength="100" required>
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-12">
				      <input type="text" class="form-control" id="car_addr1" placeholder="Address Line 1">
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-12">
				      <input type="text" class="form-control" id="car_addr2" placeholder="Address Line 2">
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-6">
				      <input type="text" class="form-control" id="car_city" placeholder="City *">
				    </div>
				    <div class="col-md-6">
				      <input type="text" class="form-control" id="car_state" placeholder="State *">
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-6">
				      <select class="form-control" id="car_country" name="con_country">
				    ...
				    <div class="col-md-6">
				      <input type="text" class="form-control" id="car_pincode" placeholder="Pincode" onkeypress='return isKeyPincode(event);'>
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-6">
				      <input type="text" class="form-control" id="car_skill" placeholder="What are your core skills areas? *" required>
				    </div>
				    <div class="col-md-6">
				      <input type="number" class="form-control" id="car_exp" placeholder="How many years of experience total? " required>
				    </div>
				  </div>
				  <div class="row">
				    <div class="col-md-12">
				      <input type="text" class="form-control" id="car_role" placeholder="What role are you applying for *" required>
				    </div>
				  </div>
                  <div class="row">
					  <div class="col-md-12">
					  	...
					  	<form id="imageform" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                            <div class="col-md-12">
                              <div class="text-center"><button type="button" value="submit" id="submit" class="button button--wayra" onclick="saveCareer()"> Register</button></div>
                           </div>
                   		</div>
                       </div>
                    </div><!-- end row -->
