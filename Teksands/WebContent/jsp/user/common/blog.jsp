...
<section class="section">
    <div class="container">
        <div class="section-title-2 text-center">
            <h1 class="home-h1">Teksands Latest Article's</h1>
            <hr>
            ...
            <div id="post-content" class="col-md-8 col-sm-12">
                <div class="content">
	                <div class="row category-section">
						<a href="/blog" class="btn btn-primary btn-square blog-button">Recent Article</a>
	                	<div class="blog-category">
					    	<select class="form-control" name="forma" onchange="location = this.value;"> 
								<option value="/blog">Select Article Category</option> 
								<option value="/blog?category=Machine Learning">Machine Learning</option> 
								<option value="/blog?category=Data Science" >Data Science</option> 
								<option value="/blog?category=Deep Learning">Deep Learning</option>
								<option value="/blog?category=Python">Python</option>
								<option value="/blog?category=DevOps">DevOps</option> 
							</select>
					    </div>
					</div>
                		...
                		<div class="row post-micro clearfix">
	                        <div class="col-md-4">
	                            <div class="post-media entry">
	                                <img src="/resources/images/blogs/${blogs.title_folder}/${blogs.photo}" alt="" class="img-responsive" style="width: 100% !important; height: 190px !important;">
	                            </div><!-- end post-media -->
	                        </div><!-- end col -->
	                        <div class="col-md-8">
	                            <h3 class="entry-title"><a href="/blog/${blogs.blog_url}" title=""><c:out value="${blogs.title}" /></a></h3>
	                            <div class="post-sharing">
	                          <div class="sharethis-inline-share-buttons"></div>
	                            </div><!-- end post-sharing -->
	                            <p class="mt-10"><c:out value="${fn:substring(blogs.short_content,0,120)}" escapeXml="false" />...</p>
	                            <a href="/blog/${blogs.blog_url}" title="" class="btn btn-primary btn-sm">Continue Reading</a>
	                        </div><!-- end col -->
            ...
            <div id="sidebar" class="col-md-4 col-sm-12 custom-sidebar">
                ...
                <div class="widget clearfix">
                    ...
                    <div class="postpager liststylepost">
                        <ul class="pager">
                        	<c:forEach items="${latestBlogs}" var="blogs">
	                            <li>
	                                <div class="post">
