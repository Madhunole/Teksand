...
.shortreads .post-micro 
{
    border-bottom: 0px solid #f4f4f7 !important;
}
</style>
...
function isNumberKey(evt) {
    ...
    if (charCode != 43 &&  charCode > 31 && (charCode < 48 || charCode > 57) && (charCode != 32 && charCode != 0) )
        return false;
    ...
    <div class="container">
        <div class="row">
            <div id="post-content" class="col-md-8 col-sm-12">
                <div class="single-content shortreads">
                    <div class="row post-micro big-post clearfix">
                        <div class="col-md-12">
                            <div class="large-post-meta">
                                <span class="avatar"><img src="" alt="" class="img-circle">Teksands</span>
                                <small>&#124;</small>
                                <span><a href="#"><i class="fa fa-clock-o"></i> <fmt:formatDate value="${article.create_date}" pattern="dd-MMM-yyyy"/></a></span>
                                <small class="hidden-xs">&#124;</small>
                                <small class="hidden-xs">&#124;</small>
                                <span class="hidden-xs"><a href="#"><i class="fa fa-eye"></i> <c:out value="${article.viewed_count}"></c:out></a></span>
                            </div><!-- end meta -->
							
                            <h1 class="entry-title"><c:out value="${article.title}"></c:out></h1>
							<div class="tags clearfix tags_share">
                            ...
                            <c:choose>
							  <c:when test="${article.photo}">
							     	<img src="/resources/images/articles/Understanding-The-Goto-Statement-In-Python/big_blog_01.jpg" alt="" class="img-responsive">
							  </c:when>							  
							  <c:otherwise>
							 		<img src="/resources/images/articles/<c:out value="${article.title_folder}"></c:out>/<c:out value="${article.photo}"></c:out>" alt="" class="img-responsive">
							  </c:otherwise>
							</c:choose>                                
                            </div><!-- end post-media -->

                            <div class="clearfix">                   
                                <p class="text-justify"><c:out value="${article.content}" escapeXml="false"></c:out></p>
