...
<div class="container-fluid">
	<div class="col-12 col-xl-auto mb-3 pl-0 ">
		<a class="btn btn-sm btn-light text-primary pl-0" href="/bootcamp/brand">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Brand Details</h6>	
        </div>
        <div class="card-body">
...
function updateBrand()
{
	...
	$.post("/bootcamp/UpdateBrandFromBrandAdmin", {
		brand_director_id: "" + brand_director_id + "",brand_cin: "" + brand_cin + "",brand_gst: "" + brand_gst + "",brand_pan: "" + brand_pan + "",brand_name: "" + brand_name + "",
	...
	{		
		...
		if(obj.status_code == 200)
		{
			...
			$.toast({
			    ...
			    afterShown: function () {
			    	setTimeout(function() {
			    		window.location.href = "/bootcamp/brand"
			    	}, 1050);
			    },
			})
