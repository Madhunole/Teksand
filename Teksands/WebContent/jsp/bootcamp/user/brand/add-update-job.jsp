...
{		
	...
	$.post("/bootcamp/brandaddOrUpdateNewJob", {id: "" + id + "",
   		...
   		if(obj.status_code == 200)
   		{
   			if(id == "")
   			{
	   			$.toast({
				    ...
				    afterShown: function () {
				    	setTimeout(function() {
				    		window.location.href = "/bootcamp/brand-jobs"
				    	}, 5000);
				    },
				}) 
   			}
...
<c:choose>
		<c:when test="${source eq 'view_jobs'}">
			<a class="btn btn-sm btn-light text-primary" href="/bootcamp/brand-view-jobs?id=${jobMaster.id}">
								...
								<div class="row">
									<div class="col-lg-12">
										 <div class="form-group form-validate">
						                    ...
						                    <input type="text" class="form-control" id="meta_title" name="meta_title" placeholder="Meta Title" value="${jobs.meta_title}" required>	                   
										</div>
									</div>
									<div class="col-lg-12">
										 <div class="form-group form-validate">
...
$(document).ready(function() {	
	if(id != '')
	{
		var clientIds =`${jobMaster.client_id}`;
...
function addUpdateNewJob()
{
	...
	$.ajaxSetup({async:false});
	$.post("/bootcamp/brandaddOrUpdateNewJob", {id: "" + id + "",job_title: "" + job_title + "",job_post_by: "" + job_post_by + "",jobs_requirement: "" + jobs_requirement + "",
...
function loadData()
{
	...
	$("#company_about").val(`${jobMaster.company_about}`);
