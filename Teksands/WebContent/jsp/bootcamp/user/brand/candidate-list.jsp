...
<div class="col-12 col-xl-auto mb-3">
    <a class="btn btn-sm btn-light text-primary" href="/bootcamp/brand-dashboard">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
            	...
            	<div class="col-lg-6">
            		<a href="/bootcamp/brand-add-update-candidate" class="btn btn-primary cms-btn cms-btn-xs float-right">Add Candidate</a>
	                            ...
	                            <td class="text-center">    
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="will-change: transform;">
                                            <a class="dropdown-item" href="/bootcamp/brand-view-candidate?id=${candidateList.id}">View</a>
                                            <a class="dropdown-item" href="/bootcamp/brand-add-update-candidate?id=${candidateList.id}">Edit</a>
...
function addTestResult()
{
	...
	$.ajaxSetup({async:false});
	$.post("/bootcamp/brandaddTestResultToCandidate", {
		candidate_id: "" + candidate_id + "",
		test_name: "" + test_name + "",
...
$(function() {
	$('#form-submit').click(function(e){
		...
		$.ajax({
		    url: '/bootcamp/brandbulkUploadCandidateDetails',
		    type: 'POST',
		    data: formData,
		    async: true,
		    cache: false,
...
{
	top.location =  "/bootcamp/brandcanidateDownloadXL";
}
</script>