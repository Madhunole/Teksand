    	...
    	<div class="col-lg-12">
    		<div class="card shadow mb-4">
		        <div class="card-header py-3">
		            <div class="row">
		            	<div class="col-lg-6"><h6 class="m-0 font-weight-bold text-primary float-left">Joining Status</h6></div>
		            	<div class="col-lg-6"><a href="javascript:void(0)" onclick="showAddNewParameterModal()" class="btn btn-primary cms-btn cms-btn-xs float-right">Add Joining Status</a></div>
		            </div>
		        </div>
		        <div class="card-body">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
	        	<h5 class="modal-title" id="brandUserTitle">Add New Joining Status</h5>
		        	...
		        	<div class="row">
		        		<div class="col-lg-12">
		        			<div class="form-group form-validate">
		            			<label class="required">Joining Status Title</label>
						    	<input type="text" class="form-control" id="para_title" name="para_title" placeholder="">
						  	</div>
		        		</div>
		        		<div class="col-lg-12">
		        			<div class="form-group form-validate">
		            			<label>Joining Status Description</label>
						    	<textarea class="form-control" id="para_description" name="para_description" rows="3"></textarea>
						  	</div>
		        		</div>		
		        		<div class="col-lg-12 text-center">
		            		<button type="submit" value="submit" id="submit" class="btn btn-primary cms-btn"> Add New Joining Status</button>
		            	</div>
		        	</div>
	        	</form>
        	</div>
...
$( document ).ready(function() {
	...
	$('#addParameter').validate({
	    ...
	    messages: {
	    	para_title: "Please Enter the Joining Status Title",
		},
...
function showAddNewParameterModal()
{
	...
	$('#brandUserTitle').html("Add Joining Status");
	$('#submit').html("Add Joining Status");
  		...
  		if(obj.status_code == 200)
   		{
  			$.toast({
			    ...
			    afterShown: function () {
			    	setTimeout(function() {
			    		window.location.href = "/bootcamp/joining-status"
			    	}, 1050);
			    },
			})
   		} else {
...
function editParameter(id)
{
	...
	$('#brandUserTitle').html("Edit Joining Status");
	$('#submit').html("Update Joining Status");
