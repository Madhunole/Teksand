    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
            	...
            	<div class="col-lg-6">
            		<a href="/bootcamp/brand-add-update-jobs" class="btn btn-primary cms-btn cms-btn-xs float-right">Post Job</a>
            	</div>
            </div>
        </div>
        <div class="card-body">
	                            ...
	                            <td class="text-center">    
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="will-change: transform;">
                                            <a class="dropdown-item" href="/bootcamp/brand-view-jobs?id=${jobMasterList.id}">View</a>                                           
                                            <a class="dropdown-item" href="/bootcamp/brand-add-update-jobs?id=${jobMasterList.id}">Edit</a>
                                        </div>
                                    </div>
                                </td>
	                        </tr>
...
{	 
	...
	var url = "/bootcamp/brand-view-jobs?id="+id;
