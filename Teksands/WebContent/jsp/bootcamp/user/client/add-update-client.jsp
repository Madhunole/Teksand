	...
	<div class="col-12 col-xl-auto mb-3 pl-0 ">
		<c:choose>
			<c:when test="${source eq 'view_client'}">
				<a class="btn btn-sm btn-light text-primary pl-0" href="/bootcamp/client/view-client?client_id=${client.id}">
        ...
        <div class="card-body">
        	<form id="addClientForm" role="form" method="post" enctype="multipart/form-data">
	            <div class="row">
	            	...
	            	<div class="col-lg-4">
	            		<div class="form-group form-validate">
	            			<label class="required">CIN/Registration No</label>
...
function addClient()
{
	...
	$.post("/bootcamp/client/addOrUpdateClient", {
