...
<div class="container-fluid">
	<div class="col-12 col-xl-auto mb-3 pl-0 ">
		<a class="btn btn-sm btn-light text-primary pl-0" href="/bootcamp/client/dashboard">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
            	...
            	<div class="col-lg-6"><a href="/bootcamp/client/add-update-client" class="btn btn-primary cms-btn cms-btn-xs float-right">Add Client</a></div>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                    	<c:forEach items="${clients}" var="client">
	                        <tr>
	                            ...
	                            <td><c:out value="${client.nature_of_business}" /></td>
	                            <td><c:out value="${client.product_and_service}" /></td>
	                            <td><fmt:formatDate pattern="dd-MM-yyyy" value="${client.created_date}" /></td>
	                            <td class="text-center">    
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="will-change: transform;">
                                            <a class="dropdown-item" href="/bootcamp/client/view-client?client_id=${client.id}">View</a>
                                            <a class="dropdown-item" href="/bootcamp/client/add-update-client?client_id=${client.id}">Edit</a>
                                        </div>
                                    </div>
                                </td>
	                        </tr>
