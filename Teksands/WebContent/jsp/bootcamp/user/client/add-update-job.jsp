...
{	
	...
	$.post("/bootcamp/client/addOrUpdateNewJob", {id: "" + id + "",
   		...
   		if(obj.status_code == 200)
   		{
   			if(id == "")
   			{
	   			$.toast({
				    ...
				    afterShown: function () {
				    	setTimeout(function() {
				    		window.location.href = "/bootcamp/client/jobs"
				    	}, 5000);
				    },
				}) 
   			}
...
<c:choose>
		<c:when test="${source eq 'view_jobs'}">
			<a class="btn btn-sm btn-light text-primary" href="/bootcamp/client/view-jobs?id=${jobMaster.id}">
