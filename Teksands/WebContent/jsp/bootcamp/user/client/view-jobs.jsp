...
<div class="col-12 col-xl-auto mb-3">
    <a class="btn btn-sm btn-light text-primary" href="/bootcamp/client/jobs">
				...
				<div class="card mb-4">
					<div class="card-header">
						<div class="row">
							...
							<div class="col-lg-8">
								<a href="/bootcamp/client/client-add-update-jobs?id=${jobMaster.id}&source=view_jobs" type="button" class="btn btn-primary cms-btn-xs cms-btn float-right mr-2">Edit</a>
								<c:choose>
				                            ...
				                            <td class="text-center">    
			                                    <div class="dropdown custom-dropdown">
			                                        ...
			                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="will-change: transform;">		                                      	
			                                            ...
			                                            <a class="dropdown-item" href="/bootcamp/client/view-candidate?id=${candidate.id}&jobId=${jobMaster.id}">View</a>
			                                            <a class="dropdown-item" href="/bootcamp/client/add-update-candidate?id=${candidate.id}">Edit</a>
			                                            <c:choose>
															<c:when test="${candidate.resume eq ''}">
      ...
      <div class="modal-body">
        <div class="row">
        	...
        	<div class="col-lg-6">
        		...
        		<input id="timePicker" name="timePicker" class="form-control form-control-sm flatpickr flatpickr-input active" type="text" placeholder="Select Time">
        	</div>
        	<div class="col-lg-12 mt-3">
        		<div class="form-group">
				    <label>Reason of Call</label>
				    <textarea class="form-control" id="reason_call" name="reason_call" rows="3"></textarea>
				</div>
        	</div>
        </div>
      </div>
...
function activateDeactivateJob(id,status)
{
	...
	$.post("/bootcamp/client/activateDeactivateJob", {id: "" + id + "", }, function(data)
	{		
...
function scheduleCall()
{
	...
	$.ajaxSetup({async:false});
	$.post("/bootcamp/client/scheduleCallToCandidate", {
...
function XlDownloadAllApplicantByJobID()
{
	...
	top.location =  "/bootcamp/client/downloadXLForAppliedCandidatesByJobID?job_id="+job_id;
}

function downloadAppliedCandidateResumes()
{
	var job_id = '${jobMaster.id}'
	top.location =  "/bootcamp/client/getAllAppliedCandidateCvAndZipAndDownload?job_id="+job_id;
}
</script>