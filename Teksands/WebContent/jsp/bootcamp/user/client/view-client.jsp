...
<section>
	<div class="container py-2">
		<div class="col-12 col-xl-auto mb-3 pl-0 ">
			<a class="btn btn-sm btn-light text-primary pl-0" href="/bootcamp/client/clients">
			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-header">
						<a href="/bootcamp/client/add-update-client?client_id=${client.id}&source=view_client" type="button" class="btn btn-primary cms-btn-xs cms-btn float-right mr-2">Edit</a>
					</div>
...
function branddeleteClientById(id)
{
	...
	swal({
      ...
      if (result.value) {
   		...
   		$.post("/bootcamp/client/deleteClientById", {client_id: "" + client_id + "", }, function(data)
   		{		
   			$.LoadingOverlay("hide");
   	  		...
   	  		if(obj.status_code == 200)
   	   		{
				    ...
				    afterShown: function () {
				    	setTimeout(function() {
				    		window.location.href = "/bootcamp/client/clients"
				    	}, 1050);
				    },
				})
   	   		} else {
...
{	
	...
	$.ajaxSetup({async:false});
	$.post("/bootcamp/client/addUpdateClientContact", {client_id: "" + client_id + "", client_contact_id: "" + client_contact_id + "",
...
function editClientContact(id)
{
	...
	$.ajaxSetup({async:false});
	$.post("/bootcamp/client/getClientContactById", {client_contact_id: "" + client_contact_id + "", }, function(data)
	{		
		var result = $.trim(data);
  		var obj = jQuery.parseJSON(result);
...
function deleteClientContactById(id)
{
	...
	swal({
      ...
      if (result.value) {
   		...
   		$.ajaxSetup({async:false});
   		$.post("/bootcamp/client/deleteClientContactByClientId", {client_contact_id: "" + client_contact_id + "", }, function(data)
   		{		
   			$.LoadingOverlay("hide");
