    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
            	...
            	<div class="col-lg-6">
            		<a href="/bootcamp/add-update-candidate" class="btn btn-primary cms-btn cms-btn-xs float-right">Add Candidate</a>
	                            ...
	                            <td class="text-center">    
                                    <div class="dropdown custom-dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="will-change: transform;">
                                            <a class="dropdown-item" href="/bootcamp/view-candidate?id=${candidateList.id}">View</a>
                                            <a class="dropdown-item" href="/bootcamp/add-update-candidate?id=${candidateList.id}">Edit</a>
		    ...
		    <form id="candidate_feedback" role="form" method="post" enctype="multipart/form-data">
			   <div class="row">
				   	<div class="col-lg-4">
	            		...
	            		<select id="can_interview_type"  id="can_interview_type" class="form-control form-control-sm" required>
...
function addTestResult()
{
	...
	$.ajaxSetup({async:false});
	$.post("/bootcamp/addTestResultToCandidate", {
		candidate_id: "" + candidate_id + "",
		test_name: "" + test_name + "",
...
$(function() {
	$('#form-submit').click(function(e){
		...
		$.ajax({
		    url: '/bootcamp/bulkUploadCandidateDetails',
		    type: 'POST',
		    data: formData,
		    async: true,
		    cache: false,
...
{
	top.location =  "/bootcamp/canidateDownloadXL";
}
</script>